(comment
  "Referred by fn-in.core, and possibly other external libs. Used for
  multimethods, which should probably be converted to protocols. (But I think
  multimethods are prettier.)")
